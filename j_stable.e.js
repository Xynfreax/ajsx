...
$$.require(['jstable.s','globalFunciones','jsimg','jsinput','jscheckselect'],function(){
  ...
  $.add=
  {
    ...
    ,online:true
    ,showTop:true
    // ,events:$f.jstable_events
    ,init:function(){
      /*alert(document.querySelector("link[href='http://localhost:3000/framework/jstable.s.css']"));*/
      // alert(this.dom.classList);
      // alert(this.getCS('color'));
    }
